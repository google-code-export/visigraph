...
import edu.belmont.mth.visigraph.models.generators.*;
	...
	public Object getAttribute( Generator.Attribute attribute )
	{
		switch( attribute )
		{
			...
			case Generator.Attribute.ISOMORPHISMS:
				return new String[ ] { "<i>K\u0305<sub>p</sub></i> empty graph + <i>K\u0305<sub>q</sub></i> empty graph + <i>K\u0305<sub>r</sub></i> empty graph + ...", "<i>K<sub>r,s</sub></i> complete bipartite graph (for <i>K</i><sub>2,<i>r,s</i></sub>)", "<i>K<sub>p,q,r</sub></i> complete tripartite graph (for <i>K</i><sub>3,<i>p,q,r</i></sub>)" };
			case Generator.Attribute.DESCRIPTION:
				return "Constructs a <i>K<sub>p,q,r,...</sub></i> complete <i>k</i>-partite graph by joining the vertices of the empty graphs <i>K\u0305<sub>p</sub></i>, <i>K\u0305<sub>q</sub></i>, <i>K\u0305<sub>r</sub></i>, ...</p><p>Vertices are placed according to the user-defined \"Arrange grid spacing\" setting.";
			...
			case Generator.Attribute.PARAMETERS_VALIDATION_EXPRESSION:
				return "^\\s*0*([1-9]\\d{0,6})(\\s+0*([1-9]\\d{0,6})){1,9999998}\\s*$";
			case Generator.Attribute.CONSTRAINTS:
				return new String[ ] { "2 \u2264 <code># of sets</code> \u2264 9,999,999", "1 \u2264 <code>order of each set</code> \u2264 9,999,999" };
			...
			case Generator.Attribute.RELATED_GENERATORS:
				return new String[ ] { "Complete bipartite graph", "Complete graph", "Complete tripartite graph" };
	...
	{
		return "Complete k-partite graph";
	}
