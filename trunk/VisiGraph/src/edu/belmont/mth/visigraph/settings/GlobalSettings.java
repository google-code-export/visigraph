...
public class GlobalSettings
{
	...
	public static final String applicationVersion = "1.08.00";
	...
	public static final Color[ ] defaultElementColors = new Color[ ] { Color.getHSBColor( 0, .75f, .95f ), Color.getHSBColor( 1 / 12f, .75f, .95f ), Color.getHSBColor( 1 / 6f, .75f, .95f ), Color.getHSBColor( 2 / 6f, .75f, .95f ), Color.getHSBColor( 3 / 6f, .75f, .95f ), Color.getHSBColor( 4 / 6f, .75f, .95f ), Color.getHSBColor( 5 / 6f, .75f, .95f ), Color.lightGray };
