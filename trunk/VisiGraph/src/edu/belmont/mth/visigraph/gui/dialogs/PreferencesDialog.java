...
public class PreferencesDialog extends JDialog implements ActionListener
{
	...
	private JScrollPane initializeUnderTheHoodPanel( )
	{
		...
		FieldLabel undoLoggingMaximumLabel            = new FieldLabel( StringBundle.get( "preferences_dialog_undo_logging_maximum_label" ) );             undoLoggingMaximumTextField            = new ValidatingTextField( 8, "\\d{0,3}" ) { { setMargin( fieldMargin ); setMaximumSize( new Dimension( 70, 100 ) ); } };
