	...
	public Object getAttribute( Function.Attribute attribute )
	{
		switch( attribute )
		{
			...
			case Function.Attribute.DESCRIPTION:
				return "Returns the average indegree of the selected vertices in the graph.  The <i>indegree</i> of a vertex is the number of head endpoints in a directed graph incident to that vertex.";
			...
			case Function.Attribute.OUTPUT:
				return "The average indegree of the selected vertices rounded to five decimal places.";
			...
			case Function.Attribute.RELATED_FUNCTIONS:
				return new String[ ] { "Get average degree", "Get average outdegree", "Get maximum degree", "Get maximum indegree", "Get maximum outdegree", "Get minimum degree", "Get minimum indegree", "Get minimum outdegree" };
