	...
	public Object getAttribute( Function.Attribute attribute )
	{
		switch( attribute )
		{
			...
			case Function.Attribute.DESCRIPTION:
				return "Returns the maximum degree of the selected vertices in the graph.  The <i>degree</i> of a vertex is the number of edges in a graph incident to that vertex (loops counted twice).";
			...
			case Function.Attribute.OUTPUT:
				return "The maximum degree of the selected vertices.";
			...
			case Function.Attribute.RELATED_FUNCTIONS:
				return new String[ ] { "Get average degree", "Get average indegree", "Get average outdegree", "Get maximum indegree", "Get maximum outdegree", "Get minimum degree", "Get minimum indegree", "Get minimum outdegree" };
