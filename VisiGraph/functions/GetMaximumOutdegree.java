	...
	public Object getAttribute( Function.Attribute attribute )
	{
		switch( attribute )
		{
			...
			case Function.Attribute.DESCRIPTION:
				return "Returns the maximum outdegree of the selected vertices in the graph.  The <i>outdegree</i> of a vertex is the number of tail endpoints in a directed graph incident to that vertex.";
			...
			case Function.Attribute.OUTPUT:
				return "The maximum outdegree of the selected vertices.";
			...
			case Function.Attribute.RELATED_FUNCTIONS:
				return new String[ ] { "Get average degree", "Get average indegree", "Get average outdegree", "Get maximum degree", "Get maximum indegree", "Get minimum degree", "Get minimum indegree", "Get minimum outdegree" };
