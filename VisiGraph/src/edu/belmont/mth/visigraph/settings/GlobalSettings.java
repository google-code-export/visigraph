...
public class GlobalSettings
{
	...
	public static final String		applicationVersion						= "2.00.08";
	...
	public static final Color		defaultEdgeHandleFill					= new Color( 64, 64, 64 );
	...
	public static final int			defaultEdgeWeightPrecision				= 3;
	public static final Color[ ]	defaultElementColors					= new Color[ ] { Color.getHSBColor( 0, .75f, .95f ), Color.getHSBColor( 1 / 12f, .75f, .95f ), Color.getHSBColor( 1 / 6f, .75f, .95f ), Color.getHSBColor( 2 / 6f, .75f, .95f ), Color.getHSBColor( 3 / 6f, .75f, .95f ), Color.getHSBColor( 4 / 6f, .75f, .95f ), Color.getHSBColor( 5 / 6f, .75f, .95f ), Color.BLACK };
	...
	public static final String		defaultLanguage							= Locale.getDefault( ).toString( );
	...
	public static final Color		defaultUncoloredEdgeLine				= new Color( 64, 64, 64 );
	public static final Color		defaultUncoloredVertexFill				= Color.lightGray;
	...
	public static final int			defaultVertexWeightPrecision			= 3;
