		...
		try
		{
			...
			while ( ( line = in.readLine( ) ) != null )
			{
				...
				if ( matcher.matches( ) && matcher.group( 1 ).equals( matcher.group( 2 ) ) )
					generatorsPanel.add( new JCheckBox( matcher.group( 1 ) )
					{
						{
							setPreferredSize( new Dimension( 375, getPreferredSize( ).height ) );
							setBackground( generatorsPanel.getBackground( ) );
						}
					} );
			}
	...
	public void loadFunctions( )
	{
		try
		{
			...
			while ( ( line = in.readLine( ) ) != null )
			{
				...
				if ( matcher.matches( ) && matcher.group( 1 ).equals( matcher.group( 2 ) ) )
					functionsPanel.add( new JCheckBox( matcher.group( 1 ) )
					{
						{
							setPreferredSize( new Dimension( 375, getPreferredSize( ).height ) );
							setBackground( functionsPanel.getBackground( ) );
						}
					} );
			}
